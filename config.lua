...
Config.Discord = {
    ...
    applicationId = '1217680070907527248',                   -- The discord application id
    iconLarge = '1024x1024',                               -- The name of the large icon
    iconLargeHoverText = 'Goshen RP', -- The hover text of the large icon
